...
CALL import_from_csv ('peers', '/Users/myregree/projects/sql/SQL2_Info21_v1.0-0/src/csv/01-init_peers.csv', ',');

TRUNCATE tasks CASCADE;
CALL import_from_csv ('tasks', '/Users/myregree/projects/sql/SQL2_Info21_v1.0-0/src/csv/02-init_tasks.csv', ',');

TRUNCATE checks CASCADE;
CALL import_from_csv ('checks', '/Users/myregree/projects/sql/SQL2_Info21_v1.0-0/src/csv/03-init_checks.csv', ',');

TRUNCATE p2p CASCADE;
CALL import_from_csv ('p2p', '/Users/myregree/projects/sql/SQL2_Info21_v1.0-0/src/csv/04-init_p2p.csv', ',');

TRUNCATE verter CASCADE;
CALL import_from_csv ('verter', '/Users/myregree/projects/sql/SQL2_Info21_v1.0-0/src/csv/05-init_verter.csv', ',');
...
CALL import_from_csv ('transferred_points', '/Users/myregree/projects/sql/SQL2_Info21_v1.0-0/src/csv/06-init_transferred_points.csv', ',');

TRUNCATE friends CASCADE;
CALL import_from_csv ('friends', '/Users/myregree/projects/sql/SQL2_Info21_v1.0-0/src/csv/07-init_friends.csv', ',');

TRUNCATE recommendations CASCADE;
CALL import_from_csv ('recommendations', '/Users/myregree/projects/sql/SQL2_Info21_v1.0-0/src/csv/08-init_recommendations.csv', ',');

TRUNCATE xp CASCADE;
CALL import_from_csv ('xp', '/Users/myregree/projects/sql/SQL2_Info21_v1.0-0/src/csv/09-init_xp.csv', ',');
...
CALL import_from_csv ('time_tracking', '/Users/myregree/projects/sql/SQL2_Info21_v1.0-0/src/csv/10-init_time_tracking.csv', ',');
